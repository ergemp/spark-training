...
public class SQLUpdateIcebergTableExample {
    public static void main(String[] args) {
        ...
        spark.sql(" UPDATE iceberg.datapoints " +
          " SET source = 'source_1' " +
          " WHERE name = 'metric_1' and value = 5 " );

        spark.sql(" UPDATE iceberg.datapoints " + 
          " SET source = 'source_2' " +
          " WHERE name = 'metric_1' and value = 10 ");

        spark.sql(" UPDATE iceberg.datapoints " +
          " SET source = 'source_3' " +
          " WHERE name = 'metric_2' and value = 5 ");

        spark.sql(" UPDATE iceberg.datapoints " + 
          " SET source = 'source_4' " +
          " WHERE name = 'metric_2' and value = 10 " );

        // Query the data
        spark.sql(
            " SELECT * " + 
            " FROM iceberg.datapoints " +  
            " ORDER BY id ").show(false);
