...
public class DfDeleteIcebergTableExample {
    public static void main(String[] args) throws CannotReplaceMissingTableException {

        // ref: https://medium.com/@tglawless/apache-iceberg-spark-sql-vs-spark-dataframes-4f51c2fec48d
        ...
        Dataset<Row> transformed_df = spark.read()
                .format("iceberg")
                .table("iceberg.datapoints")
                .orderBy("id");

        Dataset<Row> delete_df = transformed_df.where(col("source").notEqual("source_1"));
