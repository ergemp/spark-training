...
public class DfAppendIcebergTableExample {
    ...
    public static void main(String[] args) throws NoSuchTableException {
        ...
        data.add(RowFactory.create(6,"metric_2",5));
        data.add(RowFactory.create(7,"metric_1",10));
        data.add(RowFactory.create(8,"metric_2",5));
        data.add(RowFactory.create(9,"metric_1",10));
        data.add(RowFactory.create(10,"metric_2",5));


        Dataset<Row> df = spark.createDataFrame(data, schema);


        df.writeTo("iceberg.datapoints").append();
