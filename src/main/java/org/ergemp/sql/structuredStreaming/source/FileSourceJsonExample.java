...
public class FileSourceJsonExample {
    public static void main(String[] args) throws TimeoutException, StreamingQueryException {
        ...
        */
        ...
        Dataset<Row> df = spark
                ...
                .json("data/streaming/FileSourceJsonExample");    // Equivalent to format("csv").load("/path/to/directory")
