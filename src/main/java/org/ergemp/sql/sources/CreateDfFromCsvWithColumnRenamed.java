...
public class CreateDfFromCsvWithColumnRenamed {
    public static void main(String[] args) {
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("CreateDfFromCsvWithColumnRenamed")
                .master("local[*]")
                .getOrCreate();
        ...
        Dataset<Row> joined = airlinesDF.join(countriesDF,airlinesDF.col("country").equalTo(countriesDF.col("name")));
        joined.explain();
